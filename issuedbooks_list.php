...
switch ($action) {
	...
	if (IfIsUser($conn)){
		$sql = "SELECT
		    ...
		    tblissuedbooksdetail.day_fine,
		    tblissuedbooksdetail.damagepage_fine,
		    tblissuedbooksdetail.extra_fine,
		    tblissuedbooksdetail.total_fine,
								...
								<table class="table table-hover table-condensed table-striped">
									...
									<tbody>
										...
										<tr>
											<?php if (!IfIsUser($conn)) { ?>
												<td>
													...
													if (isset($row['return_date'])) {
														...
														elseif (isset($row['return_date']) && $row['return_status']=='0') {
											...
											<td><?php echo GetReturnStatus($row['return_status']); ?></td>
											<td><?php echo $row['total_fine']." Rs."; ?></td>
											...
											<?php }
												...
												if (isset($search)) {	
													...
													if ($action == 'returned' && IfIsUser($conn)) { 
														...
														echo "The total Books Requested are <b>".$total_requestedbooks."</b>.";
													}//For Admin
							...
							<div class="col-md-6">	
								<table class="table table-condensed table-hover table-dark">
									...
									<tbody>
										...
										<tr>
											<td class="text-capitalize" colspan="2">Note: Not <span class='text-success glyphicon glyphicon-ok'></span> data can cause abnormal results.</td>
										</tr>
									</tbody>
								</table>
							</div>
