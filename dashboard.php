			...
			<section id="content">
				<div class="page-wrapper">
					<div class="container-fluid">
						<div class="row">
							<div class="col">
								<h4><img class="img-responsive fixed-circle" style="max-height: auto; max-width: 20px;"src="<?php echo WEBSITE_URL; ?>/images/profile_pictures/<?php if(empty($profile_picture)){ echo '../monitor_mlms.png'; }else{ echo $profile_picture; } ?>" /><?php echo "<span class=text-capitalize> ".$_SESSION['user_name']."</span>"; ?>'s <?php if(IfIsUser($conn)){ echo "<span class=text-capitalize> User </span>"; }else{ echo "<span class=text-capitalize> Admin </span>"; } ?> Dashboard<hr/></h4>
							</div>
						</div>
							...
							<div class="col-sm-12 col-md-3">
								<div class="panel bg-success">
									<div class="panel-heading">
										<div class="row">
											<div class="col-xs-3">
												<span class="fa fa-mail-forward fa-4x"></span>
											</div>
											<div class="col-xs-9 text-right">
